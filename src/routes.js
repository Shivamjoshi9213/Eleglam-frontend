...
export const routes = [
  ...
  // },
  {
  ...
  },
   {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/Profile/OrderDetail"),
    ),
    // guard:true
  },
  {
  ...
  
  {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/TermsAndPrivacy/FaQ")
    ),
    // guard:true
  },
  {
  ...
  // },
  {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/cart/MyCart")
    ),
    // guard:true
  },
  // {
  ...
  // },
  {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/cart/AddAddress")
    ),
    // guard:true
  },
  ...
  //profile
  {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/Profile_page/Profile")
    ),
    // guard:true
  },
  {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/Profile_page/EditProfile")
    ),
    // guard:true
  },
...

  {
    ...
    layout: HomeLayout,
    component: lazy(() =>
      import("src/views/pages/Myorder")
    ),
    // guard:true
  },
